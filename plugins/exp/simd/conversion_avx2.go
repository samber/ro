...
func ScalarToInt8x32[T ~int8]() func(ro.Observable[T]) ro.Observable[*archsimd.Int8x32] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Int8x32] {
...
func ScalarToInt16x16[T ~int16]() func(ro.Observable[T]) ro.Observable[*archsimd.Int16x16] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Int16x16] {
...
func ScalarToInt32x8[T ~int32]() func(ro.Observable[T]) ro.Observable[*archsimd.Int32x8] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Int32x8] {
...
func ScalarToInt64x4[T ~int64]() func(ro.Observable[T]) ro.Observable[*archsimd.Int64x4] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Int64x4] {
...
func ScalarToUint8x32[T ~uint8]() func(ro.Observable[T]) ro.Observable[*archsimd.Uint8x32] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Uint8x32] {
...
func ScalarToUint16x16[T ~uint16]() func(ro.Observable[T]) ro.Observable[*archsimd.Uint16x16] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Uint16x16] {
			...
			sub := source.SubscribeWithContext(
				...
				ro.NewObserverWithContext(
					func(ctx context.Context, value T) {
						...
						if uint(index) == lanes {
							vec := archsimd.LoadUint16x16(&buf)
							destination.NextWithContext(ctx, &vec)
							buf = [lanes]uint16{}
							index = 0
						}
...
func ScalarToUint32x8[T ~uint32]() func(ro.Observable[T]) ro.Observable[*archsimd.Uint32x8] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Uint32x8] {
...
func ScalarToUint64x4[T ~uint64]() func(ro.Observable[T]) ro.Observable[*archsimd.Uint64x4] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Uint64x4] {
...
func ScalarToFloat32x8[T ~float32]() func(ro.Observable[T]) ro.Observable[*archsimd.Float32x8] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Float32x8] {
			...
			sub := source.SubscribeWithContext(
				...
				ro.NewObserverWithContext(
					func(ctx context.Context, value T) {
						...
						if uint(index) == lanes {
							vec := archsimd.LoadFloat32x8(&buf)
							destination.NextWithContext(ctx, &vec)
							buf = [lanes]float32{}
							index = 0
						}
...
func ScalarToFloat64x4[T ~float64]() func(ro.Observable[T]) ro.Observable[*archsimd.Float64x4] {
	...
	return func(source ro.Observable[T]) ro.Observable[*archsimd.Float64x4] {
			...
			sub := source.SubscribeWithContext(
				...
				ro.NewObserverWithContext(
					func(ctx context.Context, value T) {
						...
						if uint(index) == lanes {
							vec := archsimd.LoadFloat64x4(&buf)
							destination.NextWithContext(ctx, &vec)
							buf = [lanes]float64{}
							index = 0
						}
